...
export function DriverMePage() {
  ...
  return (
    <div className="space-y-4">
      ...
      {/*
        Above the truck and office actions, below the sync queue.

        The queue is what a driver opens this screen FOR — it is the answer to
        "did that send" and it must stay first. But the install offer belongs
        ahead of the routine actions, because it is the one thing here that is
        useful exactly once and then disappears for good.
      */}
      <InstallCard />
